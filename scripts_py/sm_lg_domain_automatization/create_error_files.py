...
#                                '20150509_dim2d_bb_trans_cv_r3.5_lin')
    main_sm_dirs = os.path.join(mainDir,
                                '20150517_dim2d_bb_trans_cv_r3.5_li')

#    main_lg_dirs = os.path.join(mainDir,
#                                '20150509_dim2d_bb_trans_cv_r3.5_large_domain')
    main_lg_dirs = os.path.join(mainDir,
                                '20150517_dim2d_bb_trans_cv_r3.5_li_large_domain')
    ...
    #create paths for large domain simulation results
    #------------------------------------------------------------
    ...
    if(dctDistanceStudy):
        ...
        temperature_array   = [0.995,0.999] #[0.95, 0.99, 0.995, 0.999]
        flow_velocity_array = [0.1]
        ...
        generate_simulation_error_files(
            ...
            temperature_array,
            flow_velocity_array,
            dct_distance_array=dct_distance_array)
    ...
    if(liPerturbationStudy):
        ...
        generate_simulation_error_files(
            ...
            temperature_array,
            flow_velocity_array,
            li_perturbation_array=li_perturbation_array)
    ...
    if(bcPerturbationStudy_T0):
        ...
        flow_velocity_array   = [0.1]
        bc_perturbation_array = [0.01,0.05] #[0.000005,0.00001,0.00005,0.0001,0.0005,0.001,0.005,0.01,0.05]
