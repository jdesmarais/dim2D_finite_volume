      ...
      module parameters_input
        ...
        !<computational times
        real(rkind), parameter :: t_max = 1050.0000000000d0
        real(rkind), parameter :: dt = 0.0007000000d0
        
        !<output writing
        real(rkind), parameter :: detail_print = 0.0001000000d0

        !<mpi choice
        integer, parameter :: npx = 4 !<number of processors along x
        integer, parameter :: npy = 6 !<number of processors along y

        !<size of the main tables
        !<careful, choose ne according to the physical model
        integer(ikind), parameter :: ntx = 116
        integer(ikind), parameter :: nty = 120
        ...
        integer, parameter :: ic_choice = phase_separation
