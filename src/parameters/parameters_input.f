      ...
      module parameters_input
        ...
        real(rkind), parameter :: x_min = 0
        real(rkind), parameter :: x_max = 1.0
        real(rkind), parameter :: y_min = 0
        real(rkind), parameter :: y_max = 1.0
        
        !<computational times
        real(rkind), parameter :: t_max = 0.0210000000d0
