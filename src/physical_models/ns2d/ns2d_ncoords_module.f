     ...
     $                                     total_energy
        ...
        private
        public :: compute_n_gradient_ns2d,
     $            compute_n_eigenvalues_ns2d,
     ...
     $            compute_n2_righteigenvector_ns2d
        ...
        !--------------------------------------------------------------
        function compute_n_gradient_ns2d(nodes,i,j,gradient,dx,dy) result(grad_var)
        ...
        end function compute_n_gradient_ns2d
        ...
        !--------------------------------------------------------------
        function compute_n_eigenvalues_ns2d(nodes) result(eigenvalues)
        ...
        end function compute_n_eigenvalues_ns2d
