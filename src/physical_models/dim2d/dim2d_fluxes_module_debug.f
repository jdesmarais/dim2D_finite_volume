     ...
     $         )
          ...
          print *, 'tranport', s%f(field_used,i,j,qx_transport_x)
          print *, 'pressure', s%f(field_used,i,j,classical_pressure)
          print *, 'viscosity', -1/re*(
     $              (2+viscous_r)*s%dfdx(field_used,i,j,velocity_x)
     $            + viscous_r*s%dfdy(field_used,i,j,velocity_y)
     $         )
          print *, 'capillarity pressure',
     $         -1/we*1.5/cv_r*s%f(field_used,i,j,capillarity_pressure)*(
     $              (s%dfdx(field_used,i,j,mass_density))**2
     $            + (s%dfdy(field_used,i,j,mass_density))**2
     $         )
     ...
     $             s%dfdy(field_used,i,j,mass_density)
          ...
          print *, 'transport', s%f(field_used,i,j,qy_transport_x)
          print *, 'viscosity + capillarity',
     $         -1/re*(
     $               s%dfdy(field_used,i,j,velocity_x)
     $             + s%dfdx(field_used,i,j,velocity_y)
     $         )
     ...
     $       result(var)
          ...
          !TAG INLINE
          var =  s%g(field_used,i,j,qy_transport_y) !validated
     $         + s%g(field_used,i,j,classical_pressure) !validated
     $         -1/re*(
     ...
     $         )
          ...
          print *, 'transport', s%g(field_used,i,j,qy_transport_y) !validated
          print *, 'viscosity',
     $         -1/re*(
     $               viscous_r*s%dgdx(field_used,i,j,velocity_x)
     $             + (2+viscous_r)*s%dgdy(field_used,i,j,velocity_y)
     ...
     $         )
          ...
          print *, 'pressure', s%g(field_used,i,j,classical_pressure) !validated
     ...
     $       result(var)
          ...
          !TAG INLINE
          var=s%f(field_used,i,j,energy_transport_x) !validated
     ...
     $               duxdx + duydy)
          ...
          print *, 'transport', s%f(field_used,i,j,energy_transport_x) !validated

          print *, 'pressure work', s%f(field_used,i,j,classical_pressure_xwork)

          print *, 'capillarity pressure work', -1/we*1.5/cv_r*
     $             s%f(field_used,i,j,capillarity_pressure_xwork)*(
     $                  (drhodx)**2
     $                + (drhody)**2)
     ...
     $       result(var)
          ...
          !TAG INLINE
          var = s%g(field_used,i,j,energy_transport_y) !validated
     $         -1/re*ux*(
     $               s%dgdy(field_used,i,j,velocity_x)
     $             + s%dgdx(field_used,i,j,velocity_y))
     $         +1/we*drhodx*drhody*ux
     $         +s%g(field_used,i,j,classical_pressure_ywork) !validated
     $         -1/we*1.5/cv_r*
     ...
     $         -1/(re*pr)*s%dgdy(field_used,i,j,temperature_eff)
          ...
          print *, 'capillarity heat transfer',
     $         +1/we*s%g(field_used,i,j,mass_density)*drhody*
     $               (duxdx+duydy)
