     ...
     $       pmodel_eq
        ...
        !---------------------------------------------------------------
        type, extends(lodi_edge_abstract) :: lodi_edge_inflow
     ...
     $     result(lodi)
          ...
          class(lodi_edge_inflow)      , intent(in) :: this
     ...
     $         c,u,v)
          ...
          temperature_forcing     = relaxation_T*(T-T_set)
          outgoing_component      = eigenvalue(ix_out)*(dPdx + sign_out*nodes(i,j,1)*c*dudx)
