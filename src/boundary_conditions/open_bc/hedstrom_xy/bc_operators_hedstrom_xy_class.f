     ...
     $       sd_operators_y_oneside_R0
        ...
        private
        public :: bc_operators_hedstrom_xy
        ...
        !---------------------------------------------------------------
        type, extends(bc_operators_openbc_normal) :: bc_operators_hedstrom_xy
          ...
          select case(obc_edge_xy_strategy)
            ...
            case(obc_edge_xy_corner)
               ...
               select case(bc_section(1))
                 ...
                 case default
                    call error_bc_section_type(
     $                   'hedstrom_xy/bc_operators_hedstrom_xy_class',
     ...
     $              timedev)
            ...
            case default
               print '(''bc_operators_hedstrom_xy_class'')'
      ...
      end module bc_operators_hedstrom_xy_class
