      !> @file
      !> module encapsulating the bf_layer_update object.
      !> bf_layer_basic enhanced with procedures modifying the
     ...
     $       rkind
        ...
        !> bf_layer_basic enhanced with intrinsic procedures
        !> to update the grdpts_id
        !
        !> @param is_bc_interior_pt
        !  check if the ID of the grdpt is bc_interior_pt
        !
        !> @param is_bc_pt
        !  check if the ID of the grdpt is bc_pt
        !
        ...
        !-------------------------------------------------------------
        type, extends(bf_layer_basic) :: bf_layer_grdpts_id_update
          ...
          procedure, pass :: check_bc_interior_pt
