      module bf_detector_dcr_list_NS_class
        ...
        end type bf_detector_dcr_list_NS
     ...
     $       sign_added_detectors)
          ...
          class(bf_detector_dcr_list_NS) , intent(in) :: this
     ...
     $     first_pt_linked, last_pt_linked)
          ...
          class(bf_detector_dcr_list_NS)              , intent(inout) :: this
     ...
     $         x_direction)
      ...
      end module bf_detector_dcr_list_NS_class
