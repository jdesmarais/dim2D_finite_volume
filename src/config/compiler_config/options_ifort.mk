...
FFLAGS_OP_IFORT		 = -O2 -ipo-c -132 -inline-factor=500 -warn notruncated_source #check if there are data that are unaligned
...
FFLAGS_PROFILE_IFORT	 = -O0 -g -132 -warn all -warn notruncated_source -check all -check noarg_temp_created -r8 -traceback -check bounds	#profiling options 
...
LDFLAGS_OP_IFORT     	 = -O2 -ipo -132 -inline-factor=500 #check if there are data that are unaligned
...
LDFLAGS_PROFILE_IFORT	 = -O0 -g -132 -warn all -check all -check noarg_temp_created -r8 -traceback -check bounds	#profiling options
