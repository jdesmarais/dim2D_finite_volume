     ...
     $       result(test_validated)
          ...
          integer             :: comm2d
          integer             :: rank
          type(mpi_mg_bc_ext) :: mpi_mg_bc_ext_used
     ...
     $         comm2d, rank)
          ...
          ! output
          !============================================================
          call mpi_mg_bc_ext_used%ini(comm2d)
          ...
          if(mpi_mg_bc_ext_used%proc_x_choice.eq.only_exchange_proc) then
             call only_exchange_twice(
     $            mpi_mg_bc_ext_used, comm2d, rank, nodes, nb_procs, [E,W])
          else
     ...
     $         .false.)
          ...
          if(mpi_mg_bc_ext_used%proc_y_choice.eq.only_exchange_proc) then
             mpi_requests = create_requests_for_one_direction(
     $            mpi_mg_bc_ext_used, comm2d, rank, nodes, N)
