     ...
     $       test_only_f=.true.)
        ...
        print '()'
        print '(''test n2_oneside_R0'')'
        print '(''----------------------------------------'')'

        !<test the operators
        test_data(1) = 5.0d0        !<test f
        test_data(2) = 19.2d0       !<test dfdx
        test_data(3) = 16.66667d0   !<test dfdy
        test_data(4) =  8.4d0       !<test d2fdx2
        test_data(5) =-511.111d0    !<test d2fdy2
        test_data(6) =-29.3333d0    !<test d2fdxdy
        test_data(7) = 10.4d0       !<test gradient_x
        ...
        test_data(15)= -20.933333d0 !<test dfdx_nl
        !test_data(16)= 1.416667d0    !<test dgdy_nl
