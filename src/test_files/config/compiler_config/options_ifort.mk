...
FFLAGS_PROFILE_IFORT	 = -O0 -g -132 -warn all '-check all, noarg_temp_created' -r8 -traceback -check bounds	#profiling options 
...
LDFLAGS_PROFILE_IFORT	 = -O0 -g -i-dynamic -132 -r8 -traceback -check bounds			#profiling options
