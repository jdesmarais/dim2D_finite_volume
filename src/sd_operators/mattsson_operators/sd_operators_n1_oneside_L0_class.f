      ...
      !-----------------------------------------------------------------
      module sd_operators_n1_oneside_L0_class
     ...
     $       sd_operators_n
        ...
        private
        public :: sd_operators_n1_oneside_L0
        ...
        !> at [i-1/2,j-1/2]
        !---------------------------------------------------------------
        type, extends(sd_operators_n) :: sd_operators_n1_oneside_L0

          contains

          procedure, nopass :: get_operator_type

          procedure, nopass :: f           => f_n1_oneside_L0
          procedure, nopass :: dfdx        => dfdx_n1_oneside_L0
          procedure, nopass :: dfdx_nl     => dfdx_n1_oneside_L0_nl
          procedure, nopass :: dfdy        => dfdy_n1_oneside_L0
          procedure, nopass :: d2fdx2      => d2fdx2_n1_oneside_L0
          procedure, nopass :: d2fdy2      => d2fdy2_n1_oneside_L0
          procedure, nopass :: d2fdxdy     => d2fdxdy_n1_oneside_L0

          procedure, nopass :: dgdx        => dgdx_n1_oneside_L0
          procedure, nopass :: dgdy_nl     => dgdy_n1_oneside_L0_nl
          procedure, nopass :: d2gdx2      => d2gdx2_n1_oneside_L0
          procedure, nopass :: d2gdxdy     => d2gdxdy_n1_oneside_L0

        end type sd_operators_n1_oneside_L0
        ...
        !---------------------------------------------------------------
        function f_n1_oneside_L0(nodes,i,j,proc) result(var)
          ...
          print '(''sd_operators_n1_oneside_L0'')'
          print '(''f_n1_oneside_L0'')'
     ...
     $            +proc(nodes,i  ,j  ))
        ...
        end function dfdx_n1_oneside_L0
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function dfdx_n1_oneside_L0_nl(
     ...
     $     result(var)
          ...
          if(rkind.eq.8) then
             ...
             !TAG INLINE
             var = 1.d0/dx*(
     $            -proc(nodes,i-1,j+1,dx,dy,gradient_n1_oneside_L0,gradient_n2_interior)
     $            +proc(nodes,i  ,j  ,dx,dy,gradient_n1_oneside_L0,gradient_n2_interior))
          else
             var = 1./dx*(
     $            -proc(nodes,i-1,j+1,dx,dy,gradient_n1_oneside_L0,gradient_n2_interior)
     $            +proc(nodes,i  ,j  ,dx,dy,gradient_n1_oneside_L0,gradient_n2_interior))
        ...
        end function dfdx_n1_oneside_L0_nl
     ...
     $            + 0.5*proc(nodes,i+1,j+1))
        ...
        end function dfdy_n1_oneside_L0
     ...
     $            )
        ...
        end function d2fdx2_n1_oneside_L0
     ...
     $            )
        ...
        end function d2fdy2_n1_oneside_L0
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function d2fdxdy_n1_oneside_L0(
     $     nodes,i,j,proc,dx,dy)
     $     result(var)
     ...
     $            0.5/(dy*dx)
        ...
        end function d2fdxdy_n1_oneside_L0          
     ...
     $            )
        ...
        end function dgdx_n1_oneside_L0
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function dgdy_n1_oneside_L0_nl(
     $     nodes,i,j,proc,dx,dy)
     $     result(var)
     ...
     $            )
        ...
        end function dgdy_n1_oneside_L0_nl        
     ...
     $            )
        ...
        end function d2gdx2_n1_oneside_L0
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function d2gdxdy_n1_oneside_L0(
     $     nodes,i,j,proc,dx,dy)
     $     result(var)
     ...
     $            1.0d0/(dx*dy)
        ...
        end function d2gdxdy_n1_oneside_L0
        
      end module sd_operators_n1_oneside_L0_class
