      ...
      !-----------------------------------------------------------------
      module sd_operators_n2_oneside_L1_class
     ...
     $       sd_operators_n
        ...
        private
        public :: sd_operators_n2_oneside_L1
        ...
        !> at [i-1/2,j-1/2]
        !---------------------------------------------------------------
        type, extends(sd_operators_n) :: sd_operators_n2_oneside_L1

          contains

          procedure, nopass :: get_operator_type

          procedure, nopass :: g           => g_n2_oneside_L1
          procedure, nopass :: dgdx        => dgdx_n2_oneside_L1
          procedure, nopass :: dgdy        => dgdy_n2_oneside_L1
          procedure, nopass :: dgdy_nl     => dgdy_n2_oneside_L1_nl
          procedure, nopass :: d2gdx2      => d2gdx2_n2_oneside_L1
          procedure, nopass :: d2gdy2      => d2gdy2_n2_oneside_L1
          procedure, nopass :: d2gdxdy     => d2gdxdy_n2_oneside_L1

        end type sd_operators_n2_oneside_L1
        ...
        !---------------------------------------------------------------
        function dfdx_n2_oneside_L1_nl(
     ...
     $     result(var)
          ...
          if(rkind.eq.8) then
             ...
             !TAG INLINE
             var = 1.0d0/dx*(
     $            -proc(nodes,i-1,j+1,dx,dy,gradient_n1_interior,gradient_n2_oneside_L1)
     $            +proc(nodes,i  ,j  ,dx,dy,gradient_n1_interior,gradient_n2_oneside_L1)
     $            )
          else
             var = 1.0/dx*(
     $            -proc(nodes,i-1,j+1,dx,dy,gradient_n1_interior,gradient_n2_oneside_L1)
     ...
     $            )
        ...
        end function dfdx_n2_oneside_L1_nl
     ...
     $            )
        ...
        end function dfdy_n2_oneside_L1
     ...
     $            )
        ...
        end function d2fdy2_n2_oneside_L1
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function d2fdxdy_n2_oneside_L1(
     $     nodes,i,j,proc,dx,dy)
     $     result(var)
     ...
     $            1.0d0/(dx*dy)
        ...
        end function d2fdxdy_n2_oneside_L1
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function g_n2_oneside_L1(nodes,i,j,proc) result(var)
          ...
          print '(''sd_operators_n2_oneside_L1'')'
          print '(''g_n2_oneside_L1'')'
     ...
     $            +proc(nodes,i  ,j  ))
        ...
        end function dgdx_n2_oneside_L1
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function dgdy_n2_oneside_L1_nl(
     $     nodes,i,j,proc,dx,dy)
     $     result(var)
     ...
     $            +proc(nodes,i  ,j  ,dx,dy,gradient_n1_interior,gradient_n2_oneside_L1))
        ...
        end function dgdy_n2_oneside_L1_nl
     ...
     $            + 0.5*proc(nodes,i+1,j+1))
        ...
        end function dgdy_n2_oneside_L1
     ...
     $            )
        ...
        end function d2gdx2_n2_oneside_L1
     ...
     $            )
        ...
        end function d2gdy2_n2_oneside_L1
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function d2gdxdy_n2_oneside_L1(
     $     nodes,i,j,proc,dx,dy)
     $     result(var)
     ...
     $            0.5/(dy*dx)
        ...
        end function d2gdxdy_n2_oneside_L1
        
      end module sd_operators_n2_oneside_L1_class
