      ...
      !-----------------------------------------------------------------
      module sd_operators_n2_oneside_R0_class
     ...
     $       sd_operators_n
        ...
        private
        public :: sd_operators_n2_oneside_R0
        ...
        !> at [i-1/2,j-1/2]
        !---------------------------------------------------------------
        type, extends(sd_operators_n) :: sd_operators_n2_oneside_R0

          contains

          procedure, nopass :: get_operator_type

          procedure, nopass :: dfdx_nl     => dfdx_n2_oneside_R0_nl
          procedure, nopass :: dfdy        => dfdy_n2_oneside_R0
          procedure, nopass :: d2fdy2      => d2fdy2_n2_oneside_R0
          procedure, nopass :: d2fdxdy     => d2fdxdy_n2_oneside_R0

          procedure, nopass :: g           => g_n2_oneside_R0
          procedure, nopass :: dgdx        => dgdx_n2_oneside_R0
          procedure, nopass :: dgdy        => dgdy_n2_oneside_R0
          procedure, nopass :: dgdy_nl     => dgdy_n2_oneside_R0_nl
          procedure, nopass :: d2gdx2      => d2gdx2_n2_oneside_R0
          procedure, nopass :: d2gdy2      => d2gdy2_n2_oneside_R0
          procedure, nopass :: d2gdxdy     => d2gdxdy_n2_oneside_R0

        end type sd_operators_n2_oneside_R0
        ...
        !---------------------------------------------------------------
        function dfdx_n2_oneside_R0_nl(
     ...
     $     result(var)
          ...
          if(rkind.eq.8) then
             ...
             !TAG INLINE
             var = 1.0d0/dx*(
     $            -proc(nodes,i-1,j+1,dx,dy,gradient_n1_interior,gradient_n2_oneside_R0)
     $            +proc(nodes,i  ,j  ,dx,dy,gradient_n1_interior,gradient_n2_oneside_R0)
     $            )
          else
             var = 1.0/dx*(
     $            -proc(nodes,i-1,j+1,dx,dy,gradient_n1_interior,gradient_n2_oneside_R0)
     ...
     $            )
        ...
        end function dfdx_n2_oneside_R0_nl
        ...
        !> ,j+\frac{1}{2}}= \frac{1}{\Delta n_2} (-u_{i-\frac{3}{2},
        !> j-\frac{1}{2}}+u_{i-\frac{1}{2},j+\frac{1}{2}})\f$
        !
        !> @date
        !> 29_01_2015 - initial version - J.L. Desmarais
        !
     ...
     $            )
        ...
        end function dfdy_n2_oneside_R0
        ...
        !> \frac{1}{{\Delta n_2^2}(
        !> u_{i-\frac{3}{2},j-\frac{1}{2}} - 2 u_{i,j-1}
     ...
     $            )
        ...
        end function d2fdy2_n2_oneside_R0
        ...
        !> (-\frac{\partial u}{\partial n_1}\bigg|_{i-\frac{3}{2},j-\frac{1}{2}} +
        !> \frac{\partial u}{\partial n_1}\bigg|_{i-\frac{1}{2},j+\frac{1}{2}}) \f$
        !
        !> @date
        !> 29_01_2015 - initial version - J.L. Desmarais
        !
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function d2fdxdy_n2_oneside_R0(
     $     nodes,i,j,proc,dx,dy)
     $     result(var)
     ...
     $            1.0d0/(dx*dy)
        ...
        end function d2fdxdy_n2_oneside_R0
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function g_n2_oneside_R0(nodes,i,j,proc) result(var)
          ...
          print '(''sd_operators_n2_oneside_R0'')'
          print '(''g_n2_oneside_R0'')'
     ...
     $            +proc(nodes,i  ,j  ))
        ...
        end function dgdx_n2_oneside_R0
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function dgdy_n2_oneside_R0_nl(
     $     nodes,i,j,proc,dx,dy)
     $     result(var)
     ...
     $            +proc(nodes,i  ,j  ,dx,dy,gradient_n1_interior,gradient_n2_oneside_R0))
        ...
        end function dgdy_n2_oneside_R0_nl
     ...
     $            + 0.5*proc(nodes,i+1,j+1))
        ...
        end function dgdy_n2_oneside_R0
     ...
     $            )
        ...
        end function d2gdx2_n2_oneside_R0
     ...
     $            )
        ...
        end function d2gdy2_n2_oneside_R0
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function d2gdxdy_n2_oneside_R0(
     $     nodes,i,j,proc,dx,dy)
     $     result(var)
     ...
     $            0.5/(dy*dx)
        ...
        end function d2gdxdy_n2_oneside_R0
        
      end module sd_operators_n2_oneside_R0_class
