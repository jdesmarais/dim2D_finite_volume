      ...
      !-----------------------------------------------------------------
      module sd_operators_n1_oneside_R0_class
     ...
     $       sd_operators_n
        ...
        private
        public :: sd_operators_n1_oneside_R0
        ...
        !> the (x+y)-direction, the functions f... are not
        ...
        !> at [i-1/2,j-1/2]
        !---------------------------------------------------------------
        type, extends(sd_operators_n) :: sd_operators_n1_oneside_R0

          contains

          procedure, nopass :: get_operator_type

          procedure, nopass :: f           => f_n1_oneside_R0
          procedure, nopass :: dfdx        => dfdx_n1_oneside_R0
          procedure, nopass :: dfdx_nl     => dfdx_n1_oneside_R0_nl
          procedure, nopass :: dfdy        => dfdy_n1_oneside_R0
          procedure, nopass :: d2fdx2      => d2fdx2_n1_oneside_R0
          procedure, nopass :: d2fdy2      => d2fdy2_n1_oneside_R0
          procedure, nopass :: d2fdxdy     => d2fdxdy_n1_oneside_R0

          procedure, nopass :: dgdx        => dgdx_n1_oneside_R0
          procedure, nopass :: dgdy_nl     => dgdy_n1_oneside_R0_nl
          procedure, nopass :: d2gdx2      => d2gdx2_n1_oneside_R0
          procedure, nopass :: d2gdxdy     => d2gdxdy_n1_oneside_R0

        end type sd_operators_n1_oneside_R0
        ...
        !---------------------------------------------------------------
        function f_n1_oneside_R0(nodes,i,j,proc) result(var)
          ...
          print '(''sd_operators_n1_oneside_R0'')'
          print '(''f_n1_oneside_R0'')'
     ...
     $            +proc(nodes,i  ,j  ))
        ...
        end function dfdx_n1_oneside_R0
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function dfdx_n1_oneside_R0_nl(
     ...
     $     result(var)
          ...
          if(rkind.eq.8) then
             ...
             !TAG INLINE
             var = 1.d0/dx*(
     $            -proc(nodes,i-1,j+1,dx,dy,gradient_n1_oneside_R0,gradient_n2_interior)
     $            +proc(nodes,i  ,j  ,dx,dy,gradient_n1_oneside_R0,gradient_n2_interior))
          else
             var = 1./dx*(
     $            -proc(nodes,i-1,j+1,dx,dy,gradient_n1_oneside_R0,gradient_n2_interior)
     $            +proc(nodes,i  ,j  ,dx,dy,gradient_n1_oneside_R0,gradient_n2_interior))
        ...
        end function dfdx_n1_oneside_R0_nl
     ...
     $            + 0.5*proc(nodes,i+1,j+1))
        ...
        end function dfdy_n1_oneside_R0
     ...
     $            )
        ...
        end function d2fdx2_n1_oneside_R0
     ...
     $            )
        ...
        end function d2fdy2_n1_oneside_R0
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function d2fdxdy_n1_oneside_R0(
     $     nodes,i,j,proc,dx,dy)
     $     result(var)
     ...
     $            0.5/(dy*dx)
        ...
        end function d2fdxdy_n1_oneside_R0          
        ...
        !> ,j-\frac{1}{2}}= \frac{1}{\Delta n_1} (-u_{i-\frac{1}{2},j-\frac{1}{2}}
        !> +u_{i+\frac{1}{2},j-\frac{3}{2}})\f$
        !
        !> @date
        !> 29_01_2015 - initial version - J.L. Desmarais
     ...
     $            )
        ...
        end function dgdx_n1_oneside_R0
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function dgdy_n1_oneside_R0_nl(
     $     nodes,i,j,proc,dx,dy)
     $     result(var)
     ...
     $            )
        ...
        end function dgdy_n1_oneside_R0_nl        
        ...
        !> \frac{1}{{\Delta n_1^2}(
        !> u_{i-\frac{1}{2},j-\frac{1}{2}} - 2 u_{i+\frac{1}{2},j-\frac{3}{2}}
        !> + u_{i+\frac{3}{2},j-\frac{5}{2}}) \f$
        !
        !> @date
        !> 29_01_2015 - initial version - J.L. Desmarais
        !
     ...
     $            )
        ...
        end function d2gdx2_n1_oneside_R0
        ...
        !> @brief
        !> compute \f$ \frac{\partial^2 u}{\partial x \partial y}
        !> \bigg|_{i-\frac{1}{2},j-\frac{1}{2}} = \frac{1}{\Delta n_1}
        !> (-\frac{\partial u}{\partial n_2}\bigg|_{i-\frac{1}{2},j-\frac{1}{2}} +
        ...
        !> data evaluated at [i,j]
        !---------------------------------------------------------------
        function d2gdxdy_n1_oneside_R0(
     $     nodes,i,j,proc,dx,dy)
     $     result(var)
     ...
     $            1.0d0/(dx*dy)
        ...
        end function d2gdxdy_n1_oneside_R0
        
      end module sd_operators_n1_oneside_R0_class
