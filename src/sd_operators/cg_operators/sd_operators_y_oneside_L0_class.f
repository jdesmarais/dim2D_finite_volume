      ...
      module sd_operators_y_oneside_L0_class
        ...
        use sd_operators_fd_module, only : gradient_y_y_oneside_L0,
     ...
     $            )
        ...
        !> ,j}= \frac{1}{\Delta y} (-u_{i-\frac{1}{2},j}
        !> +u_{i-\frac{1}{2},j+1})\f$
        !
        !> @date
        !> 30_07_2014 - initial version - J.L. Desmarais
     ...
     $            )
        ...
        !> u_{i-\frac{1}{2},j}- 2 u_{i-\frac{1}{2},j+1}
        !> + u_{i-\frac{1}{2},j+2}) \f$
        !
        !> @date
        !> 30_07_2014 - initial version - J.L. Desmarais
     ...
     $            )
        ...
        !> (-\frac{\partial u}{\partial x}\big|_{i-\frac{1}{2},j} +
     ...
     $            1.0/(dx*dy)
        ...
        !
        !> @brief
        !> compute \f$ u_{i,j-\frac{1}{2}}= \frac{1}{12} \left(
        !> 17 u_{i,j} - 5 u_{i,j+1} + u_{i,j+2} - u_{i,j+3}
        !> \right)\f$
        !
        !> @date
        !> 30_07_2014 - initial version  - J.L. Desmarais
     ...
     $            +3.0d0*proc(nodes,i,j+1,dx,dy,gradient_x_interior,gradient_y_y_oneside_L1)
     ...
     $            +3.0*proc(nodes,i,j+1,dx,dy,gradient_x_interior,gradient_y_y_oneside_L1)
     $            -    proc(nodes,i,j+2,dx,dy,gradient_x_interior,gradient_y_interior    ))
          end if
